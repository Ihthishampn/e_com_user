...
class AppColors {
  static Color primaryColor = const Color.fromARGB(255, 50, 43, 150);
  static Color sideMenu =  const Color.fromARGB(255, 13, 24, 95);
  static  Color secondary = const Color.fromARGB(255, 29, 29, 29); 
